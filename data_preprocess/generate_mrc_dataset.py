...
if __name__=="__main__":
    import os, sys
    source_file_path, target_file_path, dataset_name=sys.argv[1:4]
    generate_query_ner_dataset(source_file_path=source_file_path, dump_file_path=target_file_path,
                               entity_sign="flat",
